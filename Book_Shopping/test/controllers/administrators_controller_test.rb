...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { name: @administrator.name, password: 'secret', password_confirmation: 'secret', status: @administrator.status, username: @administrator.username }
    end
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: { name: @administrator.name, password: 'secret', password_confirmation: 'secret', status: @administrator.status, username: @administrator.username }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
